/*
  ...
  - You are about to drop the column `hostId` on the `User` table. All the data in the column will be lost.
...
INSERT INTO "new_Host" ("aboutMe", "email", "id", "name", "password", "username") SELECT "aboutMe", "email", "id", "name", "password", "username" FROM "Host";
DROP TABLE "Host";
...
INSERT INTO "new_Property" ("bathRoomCount", "bedroomCount", "description", "hostId", "id", "location", "maxGuestCount", "rating", "title") SELECT "bathRoomCount", "bedroomCount", "description", "hostId", "id", "location", "maxGuestCount", "rating", "title" FROM "Property";
DROP TABLE "Property";
